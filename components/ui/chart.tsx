        ...
        {!nestLabel ? (
          ...
          <div className="grid gap-1.5">
            {payload.map((item, index: number) => {
              ...
              return (
                <div key={item.dataKey} className="grid gap-1.5">
                  {tooltipLabel && !hideLabel ? (
                    <div className={cn("font-medium", labelClassName)}>{tooltipLabel}</div>
                  ) : null}
                          ...
                          style={
                            {
                              ...
                              "--color-border": item.payload.fill || item.color,
                            } as React.CSSProperties
                          }
                        />
...
>(({ className, hideIcon = false, payload, verticalAlign = "bottom", nameKey, ...props }, ref) => {
  ...
  return (
    <div
      ...
      {...props}
    >
      {payload.map((item: { color?: string; dataKey?: string | number; value?: string }) => {
