...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive active:scale-[0.985]",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground btn-primary-glow border border-primary/60 hover:-translate-y-0.5 hover:bg-primary/92 hover:shadow-[0_12px_28px_rgba(245,180,73,0.28)]",
        destructive:
          "bg-destructive text-white shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60",
        outline:
          "border border-border/80 bg-background/30 text-foreground shadow-sm hover:-translate-y-0.5 hover:border-primary/40 hover:bg-white/[0.03]",
        secondary:
          "bg-secondary/80 text-secondary-foreground shadow-md hover:-translate-y-0.5 hover:bg-secondary hover:shadow-lg hover:shadow-accent/10",
        ghost:
